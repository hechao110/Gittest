...
import com.pinyougou.service.pojo.*;
...
public class GoodsServiceImpl implements GoodsService {
    ...
    public void update(Goods goods) {
        ...
        //先删除后插入   先删除原有的SKU列表数据  就是删除基本表的ID
    ...
    public List<TbItem> findItemListByGoodsListAndStatus(Long[] goodsIds,String status){
        ...
        criteria.andGoodsIdIn(Arrays.asList(goodsIds));//指定条件SPU  ID  集合
